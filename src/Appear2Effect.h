...
#ifndef EFFECTS_APPEAR2_H
#define EFFECTS_APPEAR2_H
...
class Appear2Effect : public KWin::Effect {
public:
    Appear2Effect();
...
inline int Appear2Effect::requestedEffectChainPosition() const
{
    return 50;
}

#endif // EFFECTS_APPEAR2_H
